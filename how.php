...
<html lang="en">
  ...
  <body>
    ...
    <a href="<?php echo 'index.php?amazoncardcode=' . $_SESSION["url_code"] ?>" style="color: white;" class="navbar-brand">Company Name Here</a>
	  ...
	  <a href="<?php echo 'index.php?amazoncardcode=' . $_SESSION["url_code"] ?>" class="nav-link">Home</a>
          ...
          <li class="nav-item active">
            <a href="how.php" class="nav-link">How I Hacked You</a>
          </li>
    	  <li class="nav-item">
      ...
      <section>
    <br /><br />
      <h1>How I Hacked You Explanation</h1>     
      <p>Write the explanation of your attack here.</p>
